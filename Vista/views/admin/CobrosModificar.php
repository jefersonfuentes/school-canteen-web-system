...
<body>
	...
	<main class="d-flex">
		<?php echo $sidebar; ?>
		<form id="manualForm" action="./?dir=admin&controlador=Funcionario&accion=Modificar&id=2" method="POST" class="w-50 mx-auto p-4 my-4 rounded mobile-target general-shadow">
			<h1 class="fs-3">Modificar Cobrador</h1>
