...
<body>
	...
	<main class="d-flex">
		<?php echo $sidebar; ?>
		<div class="mt-4 w-50 mx-auto rounded general-shadow mobile-target overflow-hidden">
			...
			<form id="manualForm" action="./?dir=admin&controlador=Funcionario&accion=Crear&id=2" method="POST" class="px-4 pb-4">
				<h2 class="fs-3">Nuevo Cobrador</h2>
				...
				<button id="buttonModificar" disabled class="btn btn-comedor" type="submit">Crear</button>
				<a id="buttonVolverManual" type="button" class="btn btn-secondary" href="./?dir=admin&controlador=Funcionario&accion=VistasCobros&id=main">Volver</a>
			</form>
			<form class="d-none px-4 pb-4" id="excelForm">
				<div class="d-flex flex-wrap justify-content-between">
					<h2 class="fs-3 mb-0">Ingresar Cobradores</h2>
					<button type="button" id="btnPlantilla" class="btn btn-comedor">Descargar Plantilla</button>
				</div>
				<div class="mb-4 mt-3 position-relative">
					<label for="formFileLg" class="form-label d-block">Arrastra o selecciona un archivo de excel con los cobradores</label>
				...
				<button id="enviarExcel" disabled type="submit" class="btn btn-comedor">Enviar</button>
				<a id="buttonVolverManual" type="button" class="btn btn-secondary" href="./?dir=admin&controlador=Funcionario&accion=VistasCobros&id=main">Volver</a>
			</form>
		</div>
	</main>
	...
	<form id="formEnviarExcel" action="./?dir=admin&controlador=Funcionario&accion=CrearPorJSON&id=2" method="post" hidden>
	...
	<script>
		...
		btnPlantilla.addEventListener("click", function() {
			let tableExport = new TableExport(tabla, {
				exportButtons: false,
				filename: "PlantillaCobradores",
				sheetname: "PlantillaCobradores",
			});
