<header class="header sticky-top w-100">
		...
		<div class="ms-auto">
			...
			<ul class="dropdown-menu" aria-labelledby="settings">
				<li>
						<a class="dropdown-item settings__icons" href="./?controlador=Index&accion=MiCuenta">
								<i class="fa-solid fa-circle-user me-2" style="font-size: 1.2rem;"></i>
								Mi cuenta
						</a>
				</li>
				<li>
						<a class="dropdown-item settings__icons" href="./?controlador=Index&accion=Logout">
